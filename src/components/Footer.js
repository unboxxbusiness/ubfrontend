  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    ...
    >
      <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
        ...
        <li>
          <Link href="/refund" className="text-gray-500 transition hover:opacity-75">
            Refund Policy
          </Link>
        </li>
      </ul>
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        <li>
          <Link href="https://facebook.com/unboxxbusiness"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
          <Link href="https://instagram.com/unboxxbusiness"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
        ...
        <li>
          <Link href="https://twitter.com/unboxxbusiness"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
        ...
        <li>
          <Link href="https://github.com/unboxxbusiness"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
